...
export const TRANSLATIONS: Record<LanguageCode, TranslationDictionary> = {
  ...
  hi: {
    ...
    hero: {
      ...
      subtitle: 'आधुनिक जावास्क्रिप्ट और React के साथ उत्तरदायी, विश्वसनीय वेब एप्लिकेशन और स्वच्छ यूजर इंटरफेस का निर्माण।',
      summary:
  ...
  ur: {
    ...
    hero: {
      ...
      subtitle: 'جدید جاوا اسکرپٹ اور React کے ساتھ تیز رفتار، قابل اعتماد ویب ایپلیکیشنز اور بہترین یوزر انٹرفیس کی تیاری۔',
      summary:
        'کمپیوٹر سائنس کی ٹھوس بنیاد اور React، جاوا اسکرپٹ اور جدید ویب ٹیکنالوجیز کے ساتھ معیاری، ریسپانسیو اور قابل رسائی ویب ایپلی کیشنز تیار کرنے کا عملی تجربہ رکھنے والے فل اسٹیک ویب ڈویلپر۔',
  ...
  es: {
    ...
    hero: {
      ...
      subtitle: 'Desarrollo de aplicaciones web confiables, diseño responsivo e interfaces limpias con JavaScript moderno y React.',
      summary:
        'Desarrollador Web Full Stack con sólida base en ciencias de la computación y experiencia práctica construyendo aplicaciones web responsivas, accesibles y centradas en el usuario con React, JavaScript y herramientas modernas.',
